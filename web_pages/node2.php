...
<?php 
    ...
    $result = $mysqli->query("SELECT StateValue FROM smart_street_light.StreetLights WHERE Node = 2 ORDER BY ID DESC LIMIT 1"); 
...
<head>
    ...
    <title>Node 2 measurements</title>
...
<?php
    // Retrieve records for node 2 from table test and display the different states and the time in each state
    $result = mysqli_query($dbh, "SELECT State, COUNT(*)/3600 AS Time,
        ...
        CASE 
            ...
            WHEN State = 'Off' THEN (0*120*(COUNT(*)/3600))/1000
        END   
     FROM StreetLights WHERE Node = 2 GROUP BY State"); 
...
?>
    ...
    <script>
        ...
        AmCharts.ready(function () {
            ...
            var chartData = AmCharts.loadJSON('data_node2.php');
        ...
        <script>
            ...
            AmCharts.ready(function () {
                ...
                chart2.dataProvider = AmCharts.loadJSON('data_node2.php');
