...
<?php 
    ...
    $result = $mysqli->query("SELECT StateValue FROM smart_street_light.StreetLights WHERE Node = 3 ORDER BY ID DESC LIMIT 1"); // tin teleytaia metrisi pernw apo vasi me to limit 1
...
<head>
    ...
    <title>Node 3 measurements</title>
...
<?php
    ...
    $result = mysqli_query($dbh, "SELECT State, COUNT(*)/3600 AS Time,
        ...
        CASE 
            ...
            WHEN State = 'Off' THEN (0*120*(COUNT(*)/3600))/1000
        END   
     FROM StreetLights WHERE Node = 3 GROUP BY State"); 
...
?>
    ...
    <script>
        ...
        AmCharts.ready(function () {
            ...
            var chartData = AmCharts.loadJSON('data_node3.php');
        ...
        <script>
            ...
            AmCharts.ready(function () {
                ...
                chart2.dataProvider = AmCharts.loadJSON('data_node3.php');
